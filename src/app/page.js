...
let blockColour = "bg-neutral-200"
let backgroundColour = "bg-neutral-300"
  ...
  return (
    <div className={`flex w-full h-screen flex-col items-center relative 
     ...
     overflow-y-scroll`}>
      ...
      <Block extras="mt-35" name="This Nezuko" colour={blockColour} headingCol={accent1} borderColour={accentBorder} headingTextColour={accent1Text} >
