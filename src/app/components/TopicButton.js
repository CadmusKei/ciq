...
export default function TopicButton({name, colour, textColour, shadow, onClick}) {
    ...
    return (
        ...
        group hover:shadow-md hover:bg-neutral-200
        duration-900 hover:duration-200 text-black`}>

            <svg viewBox="0 0 24 24" fill="currentColor" className="size-4 rotate-270 group-hover:rotate-360 transition duration-300">
