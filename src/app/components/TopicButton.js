...
export default function TopicButton({name, colour, textColour, shadow, onClick}) {
    ...
    return (
        <div className={` h-[90%] border-2 border-neutral-400 ${colour} ${textColour}
        rounded-4xl ${shadow}/40
        flex items-center justify-start p-3 gap-2 pl-3 pr-6
        group shadow-neutral-700 hover:shadow-xl shadow-sm
        duration-900 hover:duration-200 text-neutral-200`}>
